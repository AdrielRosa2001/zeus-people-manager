 ...
 * @author Adriel Rosa
 */
public class PPerfilAluno extends javax.swing.JFrame {
    ...
    public PPerfilAluno(Admin admin){
        initComponents();
        usuario_atual = admin.getUsuario();
        nivel_acesso = admin.getNivel_de_acesso();
    }
    public PPerfilAluno(Aluno aluno){
        initComponents();
        usuario_atual = aluno.getUsuario();
        nivel_acesso = aluno.getNivel_de_acesso();
        carregarDadosCompletos();
        habilitaInputs();
        habilitarBotoes();
    }
    public PPerfilAluno(Professor professor){
        initComponents();
        usuario_atual = professor.getUsuario();
        nivel_acesso = professor.getNivel_de_acesso();
    }
    */
    
    public PPerfilAluno(String user) {
        initComponents();
        usuario = user;
        usuario_atual = user;
    ...
    public PPerfilAluno(String usuario_atu, String user, int nivel_de_acesso) {
        initComponents();
        usuario = user;
    ...
    private void initComponents() {
        ...
        inputMensalidade = new javax.swing.JTextField();
        ...
        setMinimumSize(new java.awt.Dimension(495, 680));
        setPreferredSize(new java.awt.Dimension(452, 680));
        ...
        inputMatricula.setBackground(new java.awt.Color(188, 201, 255));
        inputMatricula.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N

        jLabel21.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel21.setText("Mensalidade");

        inputMensalidade.setEditable(false);
        inputMensalidade.setBackground(new java.awt.Color(188, 201, 255));
        inputMensalidade.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(inputMatricula, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(inputMensalidade, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(30, 30, 30)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(inputMensalidade, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        setSize(new java.awt.Dimension(468, 625));
    ...
    private void btnSalvarDadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarDadosActionPerformed
        ...
        String mensalidade = inputMensalidade.getText();
        ...
        boolean retorno = conexao.updateDadosAluno(aluno);
    ...
    private void btnApagarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApagarUsuarioActionPerformed
        ...
        if (usuario_atual == usuario){
            ...
            aluno = conexao.extrairAluno(usuario);
            conexao.deletarUsuario(aluno.getId(), aluno.getNivel_de_acesso());
    ...
    private void habilitaInputs(){
        ...
        inputMensalidade.setEditable(true);
    ...
    private void carregarDadosCompletosAdmin(){
        Aluno aluno = new Aluno();
        aluno = conexao.extrairAluno(usuario);
        inputUser.setText(aluno.getUsuario());
        comboboxTipoConta.setSelectedItem("Aluno");
        inputPass.setText(aluno.getSenha());
        inputTel.setText((((aluno.getTelefone().replace(" ", "")).replace("(", "")).replace(")", "")).replace("-", ""));
        inputNomeCompleto.setText(aluno.getNome());
        inputDataDeNascimento.setText(aluno.getData_nascimento().replace("/",""));
        inputCPF.setText((aluno.getCpf().replace(".","")).replace("-", ""));
        inputEmail.setText(aluno.getEmail());
        inputEnd.setText(aluno.getEndereco());
        comboboxRecSenha.setSelectedItem(aluno.getPgt_rec_senha());
        inputRecSenha.setText(aluno.getPgt_rec_senha());
        inputMatricula.setText(aluno.getMatricula());
        inputMensalidade.setText(String.valueOf(aluno.getMensalidade()));
    }
    private void carregarDadosCompletos(){
        ...
        comboboxRecSenha.setEnabled(false);
        inputMatricula.setText(aluno.getMatricula());
        inputMensalidade.setText(String.format("%s", aluno.getMensalidade()));
    ...
    private void carregarDadosOcultos(){
        ...
        inputEmail.setText(aluno.getEmail());
        inputEnd.setText("**************");
        comboboxRecSenha.setSelectedItem("**********************");
        comboboxRecSenha.setEnabled(false);
        inputMatricula.setText("***********");
        inputMensalidade.setText("***********");
        ...
        comboboxRecSenha.setForeground(Color.red);
        inputRecSenha.setForeground(Color.red);
        inputMatricula.setForeground(Color.red);
        inputMensalidade.setForeground(Color.red);
    }
    /**
    ...
    */
    ...
    private javax.swing.JTextField inputMensalidade;
