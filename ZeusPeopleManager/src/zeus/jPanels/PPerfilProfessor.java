 ...
 * @author Adriel Rosa
 */
public class PPerfilProfessor extends javax.swing.JFrame {
    ...
    */
    ...
    public PPerfilProfessor(String user) {
        initComponents();
        usuario = user;
        usuario_atual = user;
    ...
    public PPerfilProfessor(String usuario_atu, String user, int nivel_de_acesso) {
        initComponents();
        usuario = user;
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Materia Lecionada");

        inputMateria.setEditable(false);
        inputMateria.setBackground(new java.awt.Color(188, 201, 255));
        inputMateria.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N

        jLabel21.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel21.setText("Salario:");

        inputSalario.setEditable(false);
        inputSalario.setBackground(new java.awt.Color(188, 201, 255));
        inputSalario.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(inputMateria, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(jLabel21)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(inputSalario, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(30, 30, 30)
    ...
    private void btnSalvarDadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarDadosActionPerformed
        ...
        String materia_lecionada = inputMateria.getText();
        ...
        professor.setMateriaLecionada(materia_lecionada);
        
        boolean retorno = conexao.updateDadosProfessor(professor);
    ...
    private void btnApagarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApagarUsuarioActionPerformed
        ...
        if (usuario_atual == usuario){
            ...
            professor = conexao.extrairProfessor(usuario);
            conexao.deletarUsuario(professor.getId(), professor.getNivel_de_acesso());
    ...
    private void habilitaInputs(){
        ...
        inputMateria.setEditable(true);
        inputSalario.setEditable(true);
    ...
    private void carregarDadosCompletosAdmin(){
        Professor professor = new Professor();
        professor = conexao.extrairProfessor(usuario);
        inputUser.setText(professor.getUsuario());
        comboboxTipoConta.setSelectedItem("Professor");
        inputPass.setText(professor.getSenha());
        inputTel.setText((((professor.getTelefone().replace(" ", "")).replace("(", "")).replace(")", "")).replace("-", ""));
        inputNomeCompleto.setText(professor.getNome());
        inputDataDeNascimento.setText(professor.getData_nascimento().replace("/",""));
        inputCPF.setText((professor.getCpf().replace(".","")).replace("-", ""));
        inputEmail.setText(professor.getEmail());
        inputEnd.setText(professor.getEndereco());
        comboboxRecSenha.setSelectedItem(professor.getPgt_rec_senha());
        inputRecSenha.setText(professor.getPgt_rec_senha());
        inputMateria.setText(professor.getMateriaLecionada());
        inputSalario.setText(String.format("%f",professor.getSalario()));
    ...
    private void carregarDadosOcultos(){
        ...
        comboboxRecSenha.setForeground(Color.red);
        inputRecSenha.setForeground(Color.red);
        inputSalario.setForeground(Color.red);
        inputSalario.setForeground(Color.red);
    }
    /**
